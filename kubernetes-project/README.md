...
The two existing projects "Currency Exchange Service" and "Currency Conversion Service" have been modified for Kubernetes.
You can see all the changes by searching for "CHANGE-KUBERNETES" in the commit to add the kubernetes folder
